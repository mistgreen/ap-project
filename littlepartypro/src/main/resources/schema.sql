...
(
    ...
    vendor_type_description VARCHAR
(
    250
)
    );
...
VALUES ('Jolly Giraffes', 'Rochdale', 'OL11 5BX', 'Packaged Party', 'The best soft play centre in Rochdale! We have a 3 tier main frame and a toddler area.', '1', '1', 'https://jollygiraffesltd.co.uk/'),
